...
describe("FundMe", async () => {
    ...
    describe("withdraw", () => {
        ...
        it("Withdraw ETH from the single funder", async () => {
            ...
            const { gasUsed, effectiveGasPrice } = transactionReceipt // can see those variables with debugger
            const gasCost = gasUsed.mul(effectiveGasPrice) // calculate the gas cost
        ...
        it("is allows us to withdraw with multiple funders", async () => {
            ...
            await expect(fundMe.getFunder(0)).to.be.reverted // s_funders = new address[](0) 后 funders数组没有元素，因此获取index为0的元素被reverted了
